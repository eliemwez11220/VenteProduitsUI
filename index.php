            ...
            <div class="col-md-3 mb-4">
                ...
                <div class="card mb-4">
                    ...
                    <i class="fas fa-arrow-down ml-1"></i>
                            ...
                            <a class="list-group-item list-group-item-action waves-effect">Invoices
                                <span class="badge badge-primary badge-pill pull-right">25</span>
                            </a> <a class="list-group-item list-group-item-action waves-effect">Customers
                                <span class="badge badge-primary badge-pill pull-right">75</span>
                            </a>
                        </div>
                        <!-- List group links -->
